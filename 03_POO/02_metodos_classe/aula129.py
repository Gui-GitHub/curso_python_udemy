...
class Classe:
    @staticmethod
    def funcao_que_esta_na_classe(*args, **kwargs): # Igual a uma função normal
...
funcao(1, 2, 3)
Classe.funcao_que_esta_na_classe(nomeado=1) # Igual uma função normal, só é protegido pelo escopo da classe
funcao(nomeado=1)